...
if st.session_state.theme == "light":
    ...
    <style>
        ...
        .dashboard-header h1 {{ color: white !important; margin: 0; font-size: 1.2rem; }}
        .dashboard-header p {{ color: {HELB_GOLD} !important; margin: 0; font-size: 0.7rem; }}
...
if not st.session_state.authenticated:
    ...
    with col_center:
        # GREEN BACKGROUND BOX (contains logo and text)
        st.markdown(f"""
        <div style='
        ...
        if LOGO_BASE64:
            ...
            <div style='text-align: center; margin-bottom: 1rem;'>
                <img src="data:image/png;base64,{LOGO_BASE64}" style='width: 70px; height: auto;'>
            </div>
            """, unsafe_allow_html=True)
        else:
        ...
        st.markdown(f"""
        <div style='
            background: {'white' if st.session_state.theme == 'light' else '#1e293b'};
        ...
        <div style='
            ...
            margin-top: 1rem;
            padding-top: 1rem;
            border-top: 1px solid {'#e5e7eb' if st.session_state.theme == 'light' else '#334155'};
            font-size: 0.65rem;
            color: {'#9ca3af' if st.session_state.theme == 'light' else '#64748b'};
        '>
...
with st.sidebar:
    ...
    <div style='background: rgba(255,255,255,0.15); padding: 0.8rem; border-radius: 10px; margin: 0.5rem 0; text-align: center;'>
        ...
        <div style='font-size: 0.7rem;'>{dept_display}</div>
        <div style='font-size: 0.65rem;'>{role_display}</div>
    </div>
    """, unsafe_allow_html=True)
