...
# ============================================
 ...
 # ============================================
# COMPLETE FIXED ADMIN SECTION FOR CONTRACTS
# ============================================
                ...
                if selected:
                    with st.form("admin_full_edit_form"):
                        ...
                        with col2:
                            ...
                            # ============================================
                            # FIXED: Status selection with safe handling
                            # ============================================
                            ...
                            # If current status is None or not in our list, default to 'active'
                            if current_status is None or current_status not in status_options:
                                # Check if it's a valid status that should be mapped
                                if current_status in ["completed", "done", "Complete", "Done"]:
                                    current_status = "active"  # Treat completed as active
                                elif current_status in ["pending", "Pending"]:
                                    current_status = "active"  # Treat pending as active
                                else:
                                    current_status = "active"  # Default fallback
                        ...
                        # Safely get the department index
                        try:
